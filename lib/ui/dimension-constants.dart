class DimensionsConstants {
  ...
  static double largeSpacing = 64;
  static double mediumLargeSpacing = 40;
  static double smallSpacing = 16;
  static double smallMediumSpacing = 24;
  static double extraLargeSpacing = 80;
  static double extraSmallSpacing = 8;
  ...
  static double actionButtonHeight = 56;
  static double actionButtonWidth = 160;
